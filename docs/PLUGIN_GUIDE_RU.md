...
Поведение кнопки/действия `vote` в `!mode`: запускается **общее голосование по всем режимам**, но инициатор сразу получает первый голос за выбранный им режим.
...
- Если в меню режима нажать `vote`, стартует общее голосование, и ваш голос сразу засчитывается за выбранный режим.
